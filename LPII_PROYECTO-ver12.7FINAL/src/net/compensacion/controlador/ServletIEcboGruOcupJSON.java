...
/**
 * Servlet implementation class ServletIEcboGruOcupJSON
 */
@WebServlet("/ServletIEcboGruOcupJSON")
public class ServletIEcboGruOcupJSON extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private InfoEscalafonarioService InfoEscalafonarioService;   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletIEcboGruOcupJSON() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		List<GrupoOcupa> lista=InfoEscalafonarioService.listarGrupoOcupa();
